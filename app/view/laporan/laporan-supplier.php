        ...
        <div class="container-fluid">
            <div class="card shadow mb-4">
                <div class="card-header py-2">
                    <h4 class="card-title">Laporan Supplier</h4>
                    <div class="text-end">
                        <a href="?page=laporan-supplier" class="btn btn-sm btn-outline-dark">
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                            ...
                            <tbody>
                                <?php 
                                    ...
                                    if(isset($_POST['cari'])){
                                        ...
                                        $row = $conn->query("SELECT * FROM supplier WHERE kode_supplier = '$cari' or nama_supplier = '$cari'");
                                    }else{
                        ...
                        <table>
                            <tbody>
                                <a href="?page=export-supplier" class="btn btn-outline-info is-hoverable btn-sm">
