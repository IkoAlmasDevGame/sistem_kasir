                        ...
                        <div class="form-group">
                            <?php 
                                if(isset($_GET['id'])){
                                    ...
                                    $row = $config->query("SELECT * FROM satuan WHERE id ='$id'");
                                ...
                                <table class="table table-striped-columns">
                                    <tr>
                                        <td>
                                            ...
                                            <input type="text" name="satuan" value="<?=$isi['satuan']?>" id="satuan"
                                                class="form-control" placeholder="masukkan data satauan barang ..."
                                                required>
                                        </td>
                                    </tr>
                                </table>
