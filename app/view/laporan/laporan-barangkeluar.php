        ...
        <div class="container-fluid">
            <div class="panel panel-default">
                <div class="panel-body">
                    <h4 class="panel-heading">Laporan Barang Keluar</h4>
                </div>
            </div>
            <div class="card shadow mb-4">
                <div class="card-header py-2">
                    ...
                    <div class="text-end">
                        <a href="?page=laporan-barangkeluar" class="btn btn-sm btn-info">
                ...
                <div class="table-responsive">
                    <div class="card-body">
                        <div class="form-group">
                                    ...
                                    <div class="col-sm-12 col-md-3">
                                        <div class="form-inline">
                                            <input type="text" name="cari" id="cari" class="form-control"
                                                placeholder="masukkan data barang keluar ..."
                            ...
                            <div class="mb-2"></div>
                            <form action="header.php?page=export-barangkeluar" method="post">
                            ...
                            <div class="ps-5 ms-4">
                                <a href="header.php?page=export-barangkeluar" class="text-decoration-none text-primary">
                            ...
                            <tbody>
                                <?php 
                                    ...
                                    if(isset($_POST['cari'])){
                                        ...
                                        nama_barang = '$cari' or tujuan = '$cari' order by id asc");
                                    }else{
